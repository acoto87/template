...
ctime -begin war1_build_timings.ctm
...
gcc %CommonCompilerFlags% ..\..\src\main.c ..\..\deps\include\glad\glad.c -o war1.exe %CommonLinkerFlags%
if %ERRORLEVEL% == 0 (
    REM Copy assets
	COPY %AssetsPath%\* .\
...
ctime -end war1_build_timings.ctm

REM ctime -stats war1_build_timings.ctm
REM ctime -csv war1_build_timings.ctm
